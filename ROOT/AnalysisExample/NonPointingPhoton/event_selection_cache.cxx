...
void event_selection(const char* file_name)  {
	...
	chain->AddBranchToCache("el_eta1");
	chain->AddBranchToCache("el_pt1");
	chain->AddBranchToCache("el_eta2");
	chain->AddBranchToCache("el_pt2");
	chain->AddBranchToCache("mu_pt1");
	chain->AddBranchToCache("mu_eta1");
	chain->AddBranchToCache("mu_eta2");
	chain->AddBranchToCache("mu_pt2");
	chain->AddBranchToCache("ph_eta1");
	chain->AddBranchToCache("ph_pt1");
	chain->AddBranchToCache("ph_eta2");
	chain->AddBranchToCache("ph_pt2");
	chain->AddBranchToCache("ph_t1");
	chain->AddBranchToCache("ph_t2");
	chain->AddBranchToCache("el_t1");
	chain->AddBranchToCache("el_t2");
	chain->AddBranchToCache("m_met");
	chain->AddBranchToCache("wt");
