...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_sayhello(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  MPI_Comm arg1 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:sayhello",&obj0)) SWIG_fail;
  {
    MPI_Comm *ptr = (MPI_Comm *)0;
    int res = SWIG_AsPtr_MPI_Comm(obj0, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "sayhello" "', argument " "1"" of type '" "MPI_Comm""'"); 
    }
    arg1 = *ptr;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"sayhello", _wrap_sayhello, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
